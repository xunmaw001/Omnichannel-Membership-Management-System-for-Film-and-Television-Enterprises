<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="消费对象" prop="xiaofeiduixiang">
          <el-input v-model="ruleForm.xiaofeiduixiang" 
              placeholder="消费对象" clearable  :readonly="ro.xiaofeiduixiang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="消费对象" prop="xiaofeiduixiang">
              <el-input v-model="ruleForm.xiaofeiduixiang" 
                placeholder="消费对象" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="获得积分" prop="huodejifen">
          <el-select v-model="ruleForm.huodejifen" placeholder="请选择获得积分">
            <el-option
                v-for="(item,index) in huodejifenOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="消费详情" prop="xiaofeixiangqing">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="消费详情"
                  v-model="ruleForm.xiaofeixiangqing" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.xiaofeixiangqing" label="消费详情" prop="xiaofeixiangqing">
                    <span>{{ruleForm.xiaofeixiangqing}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
	...
	xiaofeixiangqing : false,
	xiaofeiduixiang : false,
	huodejifen : false,
	xiaofeiriqi : false,
	beizhu : false,
	zhanghao : false,
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.dingdanbianhao = true;
          ...
          if(o=='xiaofeixiangqing'){
            this.ruleForm.xiaofeixiangqing = obj[o];
	    this.ro.xiaofeixiangqing = true;
            continue;
          }
          if(o=='xiaofeiduixiang'){
            this.ruleForm.xiaofeiduixiang = obj[o];
	    this.ro.xiaofeiduixiang = true;
            continue;
          }
          if(o=='huodejifen'){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
            ...
            this.$http({
              url: `option/huiyuanxinxiguanli/zhanghao`,
              method: "get"
            }).then(({ data }) => {
              if (data && data.code === 0) {
    ...
    zhanghaoChange () {
      this.$http({
        url: `follow/huiyuanxinxiguanli/zhanghao?columnValue=`+ this.ruleForm.zhanghao,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
              if(data.data.huiyuandengji){
                this.ruleForm.huiyuandengji = data.data.huiyuandengji
              }
