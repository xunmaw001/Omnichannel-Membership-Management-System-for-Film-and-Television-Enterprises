<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="播放场次" prop="bofangchangci">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.bofangchangci" 
                type="datetime"
                placeholder="播放场次">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.bofangchangci" label="播放场次" prop="bofangchangci">
              <el-input v-model="ruleForm.bofangchangci" 
                placeholder="播放场次" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
...
export default {
  ...
  methods: {
	...
	this.ruleForm.dianyingjianjie = this.ruleForm.dianyingjianjie.replace(reg,'../../../ssmc93ow/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
