    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="会员等级" prop="huiyuandengji">
          <el-select v-model="ruleForm.huiyuandengji" placeholder="请选择会员等级">
            <el-option
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="折扣" prop="zhekou">
          <el-select v-model="ruleForm.zhekou" placeholder="请选择折扣">
            <el-option
                v-for="(item,index) in zhekouOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="充值金额" prop="chongzhijine">
          <el-input v-model="ruleForm.chongzhijine" 
              placeholder="充值金额" clearable  :readonly="ro.chongzhijine"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="充值金额" prop="chongzhijine">
              <el-input v-model="ruleForm.chongzhijine" 
                placeholder="充值金额" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="使用积分" prop="shiyongjifen">
          <el-input v-model="ruleForm.shiyongjifen" 
              placeholder="使用积分" clearable  :readonly="ro.shiyongjifen"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="使用积分" prop="shiyongjifen">
              <el-input v-model="ruleForm.shiyongjifen" 
                placeholder="使用积分" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="总积分" prop="zongjifen">
            <el-input v-model="zongjifen"
                placeholder="总积分" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.zongjifen" label="总积分" prop="zongjifen">
              <el-input v-model="ruleForm.zongjifen" 
                placeholder="总积分" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
...
export default {
  ...
  computed: {
    zongjifen: {
      get: function () {
        return 0+parseFloat(this.ruleForm.huodejifen==""?0:this.ruleForm.huodejifen)-parseFloat(this.ruleForm.shiyongjifen==""?0:this.ruleForm.shiyongjifen) || 0
      }
    },
  },
  created() {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.huodejifen = true;
          ...
          if(o=='shiyongjifen'){
            this.ruleForm.shiyongjifen = obj[o];
	    this.ro.shiyongjifen = true;
            continue;
          }
          if(o=='zongjifen'){
            this.ruleForm.zongjifen = obj[o];
	    this.ro.zongjifen = true;
            continue;
          }
        }
      }
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
            ...
            this.huiyuandengjiOptions = "普通会员,中级会员,高级会员".split(',')
            this.zhekouOptions = "0.5,0.6,0.7,0.8,0.9,1".split(',')
    },
    // 下二随
    zhanghaoChange () {
      this.$http({
    ...
    info(id) {
      this.$http({
        url: `huiyuanxinxiguanli/info/${id}`,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
    ...
    onSubmit() {
      ...
      // ${column.compare}
      // ${column.compare}
        this.ruleForm.zongjifen = this.zongjifen
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `huiyuanxinxiguanli/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.huiyuanxinxiguanliCrossAddOrUpdateFlag = false;
                  this.parent.search();
