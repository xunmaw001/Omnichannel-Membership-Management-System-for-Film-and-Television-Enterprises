<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="商品简介" prop="shangpinjianjie">
          <el-input v-model="ruleForm.shangpinjianjie" 
              placeholder="商品简介" clearable  :readonly="ro.shangpinjianjie"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="商品简介" prop="shangpinjianjie">
              <el-input v-model="ruleForm.shangpinjianjie" 
                placeholder="商品简介" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
