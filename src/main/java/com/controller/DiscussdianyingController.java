...
public class DiscussdianyingController {
	...
	@IgnoreAuth
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,DiscussdianyingEntity discussdianying, HttpServletRequest request){
        EntityWrapper<DiscussdianyingEntity> ew = new EntityWrapper<DiscussdianyingEntity>();
		PageUtils page = discussdianyingService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, discussdianying), params), params));
        return R.ok().put("data", page);
    }
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<DiscussdianyingEntity> wrapper = new EntityWrapper<DiscussdianyingEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = discussdianyingService.selectCount(wrapper);
